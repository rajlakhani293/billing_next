...
const Register = () => {
  ...
  const businessTypeOptions = [
    ...
    { value: "102", label: "United States" },
    { value: "103", label: "United Kingdom" },
    { value: "104", label: "Canada" },
    { value: "105", label: "Australia" },
    { value: "106", label: "Germany" },
    { value: "107", label: "France" },
    { value: "108", label: "Japan" },
    { value: "109", label: "China" },
  ]
  ...
  const cityOptions = [
    ...
    { value: "18", label: "Pimpri-Chinchwad" },
    { value: "19", label: "Patna" },
    { value: "20", label: "Vadodara" },
    { value: "21", label: "Ghaziabad" },
    { value: "22", label: "Ludhiana" },
    { value: "23", label: "Agra" },
    { value: "24", label: "Nashik" },
    { value: "25", label: "Faridabad" },
    { value: "26", label: "Meerut" },
    { value: "27", label: "Rajkot" },
    { value: "28", label: "Kalyan-Dombivali" },
    { value: "29", label: "Vasai-Virar" },
    { value: "30", label: "Varanasi" },
  ]
